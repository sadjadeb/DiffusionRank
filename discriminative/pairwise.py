...
if __name__ == '__main__':
    ...
    if args.task == 'train':
        ...
        final_model_save_path = os.path.join(project_root, 'discriminative', 'checkpoints', f'ltr.{dataset}.pairwise.k{k}.final.pt')
        best_model_save_path = os.path.join(project_root, 'discriminative', 'checkpoints', f'ltr.{dataset}.pairwise.k{k}.best.pt')
    ...
    # Save results
    results_save_path = os.path.join(project_root, 'discriminative', 'predictions', f'ltr.{dataset}.pairwise.k{k}.best.txt')
