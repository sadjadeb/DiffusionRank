...
class ClassifierDNN(torch.nn.Module):
    def __init__(self, input_dim: int, num_hidden_layers: int = 3, num_hidden_nodes: int = 128, dropout_rate: float = 0.2, num_classes: int = 2):
